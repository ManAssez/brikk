...
?>
			...
			<tr class="recurring-totals">
				...
				<th colspan="2"><?php esc_html_e( 'Recurring totals', 'brikk' ); ?></th>
			</tr>
			...
			<?php foreach ( $recurring_carts as $recurring_cart_key => $recurring_cart ) : ?>
				...
				<tr class="cart-subtotal recurring-total">
					...
					if ( $display_th ) :
						...
						?>
						<th class="product-image">&nbsp;</th>
						<th rowspan="<?php echo esc_attr( $carts_with_multiple_payments ); ?>"><?php esc_html_e( 'Subtotal', 'brikk' ); ?></th>
						<td data-title="<?php esc_attr_e( 'Subtotal', 'brikk' ); ?>"><?php wcs_cart_totals_subtotal_html( $recurring_cart ); ?></td>
					<?php else : ?>
		...
		<?php foreach ( $recurring_carts as $recurring_cart_key => $recurring_cart ) : ?>
			...
			<tr class="order-total recurring-total">
				...
				if ( $display_th ) :
					...
					?>
					<th class="product-image">&nbsp;</th>
					<th rowspan="<?php echo esc_attr( $carts_with_multiple_payments ); ?>"><?php esc_html_e( 'Recurring total', 'brikk' ); ?></th>
					<td data-title="<?php esc_attr_e( 'Recurring total', 'brikk' ); ?>"><?php wcs_cart_totals_order_total_html( $recurring_cart ); ?></td>
				<?php else : ?>
